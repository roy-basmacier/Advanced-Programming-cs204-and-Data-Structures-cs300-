...
int main()
{
	...
	int hashSize = 24;
	HashTable<string,string> d(hashSize, 0.5, head); //loadfactorHERE
	...
	auto btsTime = (chrono::high_resolution_clock::now() - tic).count();
	cout << "\n***********************************************\n"
		 << "Benchmark results for Binary Search Tree (BST):\n"
		 << "***********************************************\n"
		 << "+ Elapsed time: " << btsTime << " ns\n"
		 << "+ Average query time: " << btsTime/queryCount  << " ns\n\n";
	...
	auto htTime = (chrono::high_resolution_clock::now() - tic).count();
	
	cout << "***********************************************\n"
		 << "Benchmark results for Hash Table:\n"
		 << "***********************************************\n"
		 << "+ Elapsed time: " << htTime << " ns\n"
		 << "+ Average query time: " << htTime/queryCount  << " ns\n"
		 << "+ Speed up: " << (btsTime/queryCount*1.0)/(1.0*htTime/queryCount +.01) << "x\n\n";
